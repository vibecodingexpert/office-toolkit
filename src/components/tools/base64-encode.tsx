...
import { Copy, Check, Trash2, Code2, RotateCcw } from "lucide-react"
  ...
  return (
    <Card className="space-y-6 p-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-lg font-semibold">Base64 Encode</h2>
      ...
      <div className="flex flex-wrap gap-3">
        <Button onClick={handleEncode} loading={loading} icon={<Code2 className="h-4 w-4" />}>
          Encode
        </Button>
        {input && (
      ...
      {output && (
        ...
        >
          <div className="flex items-center justify-between">
            <label className="text-sm font-medium text-foreground">Encoded Output</label>
            <button
              onClick={handleCopy}
