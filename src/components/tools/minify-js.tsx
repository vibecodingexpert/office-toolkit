  ...
  return (
    <Card className="space-y-6 p-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-lg font-semibold">Minify JavaScript</h2>
          <p className="text-sm text-muted-foreground">
            Minimize2 JavaScript by removing whitespace and comments
          </p>
        </div>
      </div>

      <div className="space-y-2">
        <label className="text-sm font-medium text-foreground">JavaScript Input</label>
        <textarea
          value={input}
      ...
      {output && (
        ...
        >
          ...
          <div className="rounded-xl border border-border bg-zinc-950 dark:bg-zinc-900 p-4 overflow-auto max-h-64">
            <pre className="whitespace-pre-wrap break-all text-sm font-mono text-sky-400 leading-relaxed">
              {output}
            </pre>
          </div>
        </motion.div>
