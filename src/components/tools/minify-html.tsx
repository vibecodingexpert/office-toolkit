...
import { Copy, Check, Minimize2, RotateCcw, ArrowDown } from "lucide-react"
  ...
  return (
    <Card className="space-y-6 p-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-lg font-semibold">Minify HTML</h2>
          <p className="text-sm text-muted-foreground">
            Minimize2 HTML by removing whitespace and comments
          </p>
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          placeholder="<html><body><div class='content'>...</div></body></html>"
          rows={7}
