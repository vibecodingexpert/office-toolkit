...
import {
  Upload, Download, FileText, Check, X, FileDown, Lock, KeyRound,
} from "lucide-react"
import { encryptPDF } from "@/lib/utils/pdf-utils"
...
export function LockPdf() {
  ...
  }, [fileInfo, password, confirmPassword])
              ...
              <div className="flex items-center justify-between rounded-xl bg-gradient-to-r from-emerald-500/5 to-primary/5 border border-emerald-500/10 p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Password encryption · {formatSize(fileInfo.resultSize)}</p>
                  </div>
                </div>
