...
function simulateSlides(size: number): number {
  return Math.max(1, Math.floor(size / 80000))
}
          ...
          {isProcessing && (
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                Converting PowerPoint to PDF ({fileInfo.slides} slides)...
              </div>
              ...
              <div className="flex items-center justify-between rounded-xl bg-gradient-to-r from-emerald-500/5 to-primary/5 border border-emerald-500/10 p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">{fileInfo.slides} slides · {formatSize(fileInfo.convertedSize)}</p>
                  </div>
                </div>
