...
import {
  Upload, Download, EarOff, Music, Check, X,
} from "lucide-react"
import { removeNoise, getFFmpeg } from "@/lib/utils/media-utils"
              ...
              <div className="rounded-xl bg-gradient-to-r from-pink-500/5 to-pink-500/10 border border-pink-500/10 p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">{formatSize(cleanedSize)}</p>
                  </div>
